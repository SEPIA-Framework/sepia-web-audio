...
*/
let PorcupineBuilder = (function() {
    //Porcupine = PorcupineBuilder();
    return (function(wasmFileArrayBuffer, defaultWasmBinaryFile, moduleLoadCallback) {
        /**
        ...
        if (moduleLoadCallback != undefined){
			callback = moduleLoadCallback;
		}else if (typeof PorcupineOptions !== "undefined") {
            if (PorcupineOptions !== null && typeof PorcupineOptions.callback !== "undefined") {
