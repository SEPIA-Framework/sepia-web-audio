//supports: SepiaFW.files
var PorcupineModule = (function() {
    var _scriptDir = typeof document !== 'undefined' && document.currentScript ? document.currentScript.src : undefined;
    return (
        function(wasmFileArrayBuffer, defaultWasmBinaryFile) {
            var PorcupineModule = {};
			var wasmBinaryFile = defaultWasmBinaryFile || "porcupine-14.wasm"; 	//original: "pv_porcupine.wasm";
            ...
            if (ENVIRONMENT_IS_NODE) {
				...
				if (typeof SepiaFW == "object" && SepiaFW.files) {
					Module["optimizedBinaryReadPromise"] = function(url){
						//console.error('optimizedBinaryReadPromise URL: ' + url);
						return new Promise(function(resolve, reject) {
							function onsuccess(arraybuffer){
								//console.error('optimizedBinaryReadPromise success');
								resolve(arraybuffer);
							}
							function onerror(e){
								//console.error('optimizedBinaryReadPromise error: ' + e);
								reject(e);
							}
            ...
            function integrateWasmJS() {
                ...
                if (!isDataURI(wasmBinaryFile) && !isHttpReq(wasmBinaryFile)) {
                ...
                function getBinaryPromise() {
					if (wasmFileArrayBuffer){
						console.error('getBinaryPromise found pre-loaded wasmFileArrayBuffer');			//DEBUG
						return new Promise(function(resolve, reject){
							resolve(wasmFileArrayBuffer);
						});
                    }else if (Module["optimizedBinaryReadPromise"]) {
            ...
            STATICTOP = STATIC_BASE + 1606432;
            __ATINIT__.push();
            var STATIC_BUMP = 1606432;
