var PorcupineBuilder = function(wasmFileArrayBufferOrBase64Str, defaultWasmBinaryFile, moduleLoadCallback) {
	//@picovoice/porcupine-web-en-factory - v2.1.4 - 2022.03.03 - LICENSE: Apache-2.0
	//Modified for SEPIA:
	...
	*/
	var PorcupineWebFactory = (function (exports) {
		...
		*/
		...
		function getPvStorage() {
		  if (self.indexedDB) {
			...
			return {
			  setItem: function () {
				var _setItem = _asyncToGenerator$1( /*#__PURE__*/regenerator$1.mark(function _callee(key, value) {
				  var db, request;
			  ...
			  getItem: function () {
				var _getItem = _asyncToGenerator$1( /*#__PURE__*/regenerator$1.mark(function _callee2(key) {
				  var db, request, res;
			  ...
			  removeItem: function () {
				var _removeItem = _asyncToGenerator$1( /*#__PURE__*/regenerator$1.mark(function _callee3(key) {
				  var db, request;
		...
		function _fetchWithTimeout() {
		  _fetchWithTimeout = _asyncToGenerator$1( /*#__PURE__*/regenerator$1.mark(function _callee4(uri) {
			var options,
				time,
				controller,
				config,
		...
		*/
		...
		function _buildWasm() {
		  _buildWasm = _asyncToGenerator$1( /*#__PURE__*/regenerator$1.mark(function _callee8(memory, wasm_base64) {
				...
				switch (_context8.prev = _context8.next) {
				  case 0:
					...
					pvHttpsRequestWasm = /*#__PURE__*/function () {
					  var _ref = _asyncToGenerator$1( /*#__PURE__*/regenerator$1.mark(function _callee(httpMethodAddress, serverNameAddress, endpointAddress, headerAddress, bodyAddress, timeoutMs, responseAddressAddress, responseSizeAddress, responseCodeAddress) {
					...
					pvFileLoadWasm = /*#__PURE__*/function () {
					  var _ref2 = _asyncToGenerator$1( /*#__PURE__*/regenerator$1.mark(function _callee2(pathAddress, numContentBytesAddress, contentAddressAddress, succeededAddress) {
					...
					pvFileSaveWasm = /*#__PURE__*/function () {
					  var _ref3 = _asyncToGenerator$1( /*#__PURE__*/regenerator$1.mark(function _callee3(pathAddress, numContentBytes, contentAddress, succeededAddress) {
						var path, content;
						return regenerator$1.wrap(function _callee3$(_context3) {
						  while (1) {
							switch (_context3.prev = _context3.next) {
					...
					pvFileExistsWasm = /*#__PURE__*/function () {
					  var _ref4 = _asyncToGenerator$1( /*#__PURE__*/regenerator$1.mark(function _callee4(pathAddress, isExistsAddress, succeededAddress) {
						var path, isExists;
						return regenerator$1.wrap(function _callee4$(_context4) {
						  while (1) {
							switch (_context4.prev = _context4.next) {
					...
					pvFileDeleteWasm = /*#__PURE__*/function () {
					  var _ref5 = _asyncToGenerator$1( /*#__PURE__*/regenerator$1.mark(function _callee5(pathAddress, succeededAddress) {
						var path;
					...
					pvGetBrowserInfo = /*#__PURE__*/function () {
					  var _ref6 = _asyncToGenerator$1( /*#__PURE__*/regenerator$1.mark(function _callee6(browserInfoAddressAddress) {
					...
					pvGetOriginInfo = /*#__PURE__*/function () {
					  var _ref7 = _asyncToGenerator$1( /*#__PURE__*/regenerator$1.mark(function _callee7(originInfoAddressAddress) {
						var _self$origin;
					...
					if (PORCUPINE_WASM_ARRAY) {
						...
						if (!wasm_base64) wasm_base64 = PORCUPINE_WASM_BASE64;
		...
		*/
		...
		var Porcupine = /*#__PURE__*/function () {
		  ...
		  createClass(Porcupine, [{
			...
			key: "initWasm",
			value: function () {
			  var _initWasm = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee6(accessKey, keywordModels, keywordModelSizes, sensitivities) {
				  ...
				  while (1) {
					switch (_context6.prev = _context6.next) {
					  case 0:
						...
						_context6.next = 6;
						return buildWasm(memory, PORCUPINE_WASM_BASE64);
					  ...
					  case 17:
						keywordIndexAddress = _context6.sent;
					  ...
					  case 34:
						keywordModelSizeAddress = _context6.sent;
					  ...
					  case 40:
						...
						_context6.t0 = keywordModelAddresses;
						_context6.next = 44;
					  ...
					  case 54:
						keywordModelAddressAddress = _context6.sent;
					  ...
					  case 60:
						sensitivityAddress = _context6.sent;
					  ...
					  case 66:
						...
						_context6.t2 = Error;
						_context6.t3 = "'pv_porcupine_init' failed with status ";
						_context6.t4 = arrayBufferToStringAtIndex;
						_context6.t5 = memoryBufferUint8;
						_context6.next = 74;
					  ...
					  case 74:
						...
						_context6.t8 = _context6.t3.concat.call(_context6.t3, _context6.t7);
						throw new _context6.t2(_context6.t8);
					  ...
					  case 92:
						inputBufferAddress = _context6.sent;
