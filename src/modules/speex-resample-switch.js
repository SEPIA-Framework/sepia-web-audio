...
class SpeexResampleProcessor extends AudioWorkletProcessor {
	...
	constructor(options) {
		...
		this.targetSampleRate = options.processorOptions.targetSampleRate || options.processorOptions.ctxInfo.targetSampleRate || this.sourceSamplerate;
		...
		this.emitterBufferSize = options.processorOptions.bufferSize || 512;	//TODO: there is probably a mismatch (we should go back to the idea of making the buffer bigger but pull less)
